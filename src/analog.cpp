/*
 * ======================================================================================================================
 *  analog.cpp - Analog Pin Monitoring - Adjust the array to control what analog pins are being monitored
 * ======================================================================================================================
 */
#include <Particle.h>
...
void analog_initialize() {
  ...
  // Pin A2 - if AS5600_exists then is must not be set. AKA we do WIND automatically 
